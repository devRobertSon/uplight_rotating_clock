...
| D26 | 샤프트 길이 | 75 mm → **100 mm** 신규 발주 (75 mm × 10개 폐기) | D25 양 보스 12 mm 적용으로 스택 12+12+6+44+6+12+5 = 97 mm. 75 mm로는 22 mm 부족, 100 mm로 약 3 mm 마진. Frame 측면 기둥 140 mm 재검토는 §7 Frame Section 모델링 시 별도 처리 |

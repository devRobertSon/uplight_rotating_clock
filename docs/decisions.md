...
| D27 | Frame 측면 기둥 높이 | 140 mm → **160 mm** | D25/D26 후 전체 envelope 재계산: 모터 19 + 커플러 25 + 보스 12 + 캡 6 + 드럼 44 + 캡 6 + 보스 12 + 베어링 5 + 상하 plate ≈ 147 mm. 160 mm로 상향해 약 13 mm 조립 버퍼 확보 (시계 외형 높이 590 × 95 × 160) |
